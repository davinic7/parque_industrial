...
define('CLOUDINARY_CLOUD_NAME', env('CLOUDINARY_CLOUD_NAME', 'dwazrbs09'));
define('CLOUDINARY_API_KEY', env('CLOUDINARY_API_KEY', '315425839631656'));
define('CLOUDINARY_API_SECRET', env('CLOUDINARY_API_SECRET', 'OPF3X1CS0QtJTY5Z-7KQm46SJQs'));